...
function SocialLinks(){
    return(
        <div className="flex sm:items-center my-3 px-2" >
            <a href="https://github.com/Amansingh-me" target="_blank" rel="noreferrer" title="linkedIn" className="w-5 mr-5 sm:mx-2.5" >
            ...
            <a href="https://github.com/Amansingh-me" target="_blank" rel="noreferrer" title="email" className="w-5 mr-5 sm:mx-2.5" >
